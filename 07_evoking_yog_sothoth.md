...
>注釈1：「ヨグ＝ソトースの召喚」について
>
>本章「ヨグ＝ソトースの召喚」は、そのタイトルから受ける印象とは裏腹に、前半では非常に綿密で読み応えのある理論構築が展開されている。アース・ライト現象や電磁場、カオス数学といった自然科学や現代魔術の知見をベースに、フィル・ハインは「存在とはなにか」「精霊とはどう構築され、どのように作用するのか」というテーマを多角的に掘り下げている。
>
>とりわけ注目すべきは、フィル・ハインによる「エンティティ概念」の日本語圏ではまとまって紹介される機会が少ないため、本章は貴重である。ハインはサーヴィターや精霊といった存在を、エネルギーと情報の交差点として再定義し、魔術的存在とは「想像上の産物」か「実在の霊的存在」かという二項対立を軽やかに超えていく。
>
>また、ウィリアム・ギブスンの『ニューロマンサー』やディオン・フォーチュンの『宇宙の教義』などからの引用を交えつつ、情報構造体（construct）としての精霊と、人間の無意識・文化・地磁気との相互作用についての実験的仮説を積み重ねていく構成は、まさにケイオス・マジック以後の思考を象徴するものだろう。
>
