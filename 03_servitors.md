...
サーヴィター（Servitor）とは、ある任務や役割を遂行させるために、喚起技法を用いて意図的に創造された存在である。西洋のエソテリック・トラディションにおいては、このような存在は「思念体（Thought-Form）」と呼ばれることもあり、たとえばチベット密教においては「タルパ（Tulpa）」として知られている。このような汎用型サーヴィターには、いくつかの利点がある。

サーヴィターは、特定の状況や出来事に特化して創られることもあれば、たとえば「癒し」といった特定の分野において、より汎用的な用途のために創られることもある。このような汎用型サーヴィターには、いくつかの利点がある。
...
創造的飛躍が生じるたびに、あるいは思いついたアイデアが実際に使える形になったたびに、その影響力はますます強まっていった。
...
最終的に、私はこのサーヴィターを召還し直し、霊的覚醒（illumination）に関する断片として再構成されるように分解した。
この経験から教訓を得て以降、私はこの元のサーヴィターの断片を創造性の焦点としてときおり使用する程度にとどめている。

ウイルス的サーヴィター（Viral Servitors）
サーヴィターには、自己複製・自己増殖するように設計することも可能である。
...
設定された期限を過ぎた時点で、このサーヴィターは混乱の場（confusion field）を生成し始めた──失くした鍵、電気系統のトラブル、その他の些細ながらイライラさせるような障害である。
