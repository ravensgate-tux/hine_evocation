...
サーヴィター（Servitor）とは、ある任務や役割を遂行させるために、喚起の技術を用いて創造された存在のことである。西洋のエソテリック・トラディションにおいては、このような存在は「思念体（Thought-Form）」と呼ばれ、チベット密教においては「タルパ（Tulpa）」としても知られている。このような汎用型のサーヴィターには、有益な点がいくつもある。

サーヴィターは、特定の状況や出来事に特化して創られることもある。また「癒し」といった特定の分野においてその用途のために創られることもある。このような汎用型サーヴィターには、いくつかの利点がある。

第一に、それは「エキスパートシステム」として設計でき、与えられた任務を通じて学習をする。たとえば、癒しの任務を繰り返し行うことで、より効果的なヒーリングを行えるようになる。

第二に、そのサーヴィターを継続的に使用し、実際に効果を体験することによって、使用者の側に「信頼感」が構築されていく。汎用型のサーヴィターは、その起動手順（マントラ、シジル、イメージの視覚化シークエンスなど）を知っている者なら誰でも、任務を遂行させることができる。

このタイプのサーヴィターの例として、「ICANDOO（アイ・キャン・ドゥー）」という存在がある。ICANDOOは、サーヴィター創造のための公開グループ・ワークショップにおいて創られた存在で、その名（I-can-do＝「私はできる」）がそのまま召喚のマントラにもなっていた。その一般的な役割は、使用者が直面するあらゆる障害を乗り越える手助けをすることにあった。
