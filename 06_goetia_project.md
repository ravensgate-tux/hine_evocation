...
>
>本章は、1989年にハインが同僚とともに開始した長期的実践「ゴエティア・プロジェクト」の報告である。目的は、伝統的グリモワールを実際に検証し、その成果を分析したうえで、ポストモダン時代に適したゴエティアの一般的アプローチを構築することにあった。
>
>初期実験では、あえて魔法陣や三角形といった伝統的構造を用いずに召喚を試みた。その結果、作業は明確な輪郭を欠き、精霊のヴィジョンも曖昧で、実践者は活力の低下や体調不良を経験することとなる。
>
>これを踏まえ、彼らは『小鍵』の規則に従い、恒久的な円と三角形を設置した。以後、儀式は伝統的手順に則って行われ、顕現の安定性は明らかに向上した。
>
>この報告は、ゴエティアにおける「構造」の役割を示唆している。円と三角形は単なる形式ではなく、召喚空間を限定し、顕現を安定させるための機能的装置として働いているのである。
>
