...
>
>特筆すべきは、初期実験において“魔法陣も三角形も使わず”に作業を始めたという点である。これは「既存の魔術体系を再解釈し、独自の文脈で再構成する」というケイオスマジック的アプローチであり、同時にそれ自体が一時的自律空間（Temporary Autonomous Zone, TAZ）的な性格を帯びていたとも言える。つまり、伝統的構造の外に場を設け、そこにおいて新しい秩序（精霊との接触）を試みたのである。
>
